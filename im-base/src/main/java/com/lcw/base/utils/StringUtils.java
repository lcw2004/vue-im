...
//            e.printStackTrace();
    ...
    public static long calculateMaxFileSize(String maxFileSizeStr) {
    ...
    public static int indexWithCase(String input, String keyWord) {
        int fromIndex = input.indexOf(keyWord);
        if (fromIndex == -1) {
            fromIndex = input.indexOf(keyWord.toUpperCase());
        }
        return fromIndex;
    }

    public static boolean containWithCase(String input, String keyWord) {
        return input.contains(keyWord) || input.contains(keyWord.toUpperCase());
    }

    public static boolean startsWithWithCase(String input, String keyWord) {
        return input.startsWith(keyWord) || input.startsWith(keyWord.toUpperCase());
    }
