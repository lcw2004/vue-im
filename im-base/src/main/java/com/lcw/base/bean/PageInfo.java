...
public class PageInfo<T> {
    ...
    public void setPageSize(Integer pageSize) {
        ...
        this.pageSize = this.pageSize > 1000 ? 10000 : this.pageSize;
    }
    ...
    public <E> PageInfo<E> copy() {
        PageInfo<E> pageInfo = new PageInfo<E>();
        pageInfo.setPageNo(getPageNo());
        pageInfo.setPageSize(getPageSize());
        pageInfo.setPageCount(getPageCount());
        pageInfo.setCount(getCount());
        pageInfo.setExt(getExt());
        return pageInfo;
    }
}
